...
/* CUSTOM */ DEFINE_OBJECT(object_gi_heatgear, OBJECT_GI_HEATGEAR)
/* CUSTOM */ DEFINE_OBJECT(object_giant_plant, OBJECT_GIANT_PLANT)
/* CUSTOM */ DEFINE_OBJECT(object_seed, OBJECT_SEED)
/* CUSTOM */ DEFINE_OBJECT(object_reactor, OBJECT_REACTOR)
/* CUSTOM */ DEFINE_OBJECT(object_clock_tower, OBJECT_CLOCK_TOWER)
/* CUSTOM */ DEFINE_OBJECT(object_gear, OBJECT_GEAR)
/* CUSTOM */ DEFINE_OBJECT(object_water_plane, OBJECT_WATER_PLANE)
/* CUSTOM */ DEFINE_OBJECT(object_wall_pull_switch, OBJECT_WALL_PULL_SWITCH)
/* CUSTOM */ DEFINE_OBJECT(object_fan, OBJECT_FAN)
/* CUSTOM */ DEFINE_OBJECT(object_swim_ring, OBJECT_SWIM_RING)
/* CUSTOM */ DEFINE_OBJECT(object_water_shutter, OBJECT_WATER_SHUTTER)
/* CUSTOM */ DEFINE_OBJECT(object_water_pipe, OBJECT_WATER_PIPE)
/* CUSTOM */ DEFINE_OBJECT(object_air_vent, OBJECT_AIR_VENT)
/* CUSTOM */ DEFINE_OBJECT(object_bookshelf_door, OBJECT_BOOKSHELF_DOOR)
/* CUSTOM */ DEFINE_OBJECT(object_gi_boosters, OBJECT_GI_BOOSTERS)
/* CUSTOM */ DEFINE_OBJECT(object_gi_mirror_shield, OBJECT_GI_MIRROR_SHIELD)
/* CUSTOM */ DEFINE_OBJECT(object_gi_zora_apparatus, OBJECT_GI_ZORA_APPARATUS)
/* CUSTOM */ DEFINE_OBJECT(object_boost_breakwall, OBJECT_BOOST_BREAKWALL)
/* CUSTOM */ DEFINE_OBJECT(object_rotating_platform, OBJECT_ROTATING_PLATFORM)
/* CUSTOM */ DEFINE_OBJECT(object_rat, OBJECT_RAT)
