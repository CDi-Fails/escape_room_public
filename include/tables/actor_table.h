...
/* CUSTOM */ DEFINE_ACTOR(Dummy, ACTOR_DUMMY, ACTOROVL_ALLOC_NORMAL, "Dummy")
/* CUSTOM */ DEFINE_ACTOR(Seed, ACTOR_SEED, ACTOROVL_ALLOC_NORMAL, "Seed")
/* CUSTOM */ DEFINE_ACTOR(Giant_Plant, ACTOR_GIANT_PLANT, ACTOROVL_ALLOC_NORMAL, "Giant_Plant")
/* CUSTOM */ DEFINE_ACTOR(Darkness, ACTOR_DARKNESS, ACTOROVL_ALLOC_NORMAL, "Darkness")
/* CUSTOM */ DEFINE_ACTOR(Reactor, ACTOR_REACTOR, ACTOROVL_ALLOC_NORMAL, "Reactor")
/* CUSTOM */ DEFINE_ACTOR(Reactor_Circuit, ACTOR_REACTOR_CIRCUIT, ACTOROVL_ALLOC_NORMAL, "Reactor_Circuit")
/* CUSTOM */ DEFINE_ACTOR(Reactor_Fans, ACTOR_REACTOR_FANS, ACTOROVL_ALLOC_NORMAL, "Reactor_Fans")
/* CUSTOM */ DEFINE_ACTOR(Reactor_Fuel, ACTOR_REACTOR_FUEL, ACTOROVL_ALLOC_NORMAL, "Reactor_Fuel")
/* CUSTOM */ DEFINE_ACTOR(Reactor_Rods, ACTOR_REACTOR_RODS, ACTOROVL_ALLOC_NORMAL, "Reactor_Rods")
/* CUSTOM */ DEFINE_ACTOR(Reactor_Scale, ACTOR_REACTOR_SCALE, ACTOROVL_ALLOC_NORMAL, "Reactor_Scale")
/* CUSTOM */ DEFINE_ACTOR(Reactor_Fuel_Slot, ACTOR_REACTOR_FUEL_SLOT, ACTOROVL_ALLOC_NORMAL, "Reactor_Fuel_Slot")
/* CUSTOM */ DEFINE_ACTOR(Chain_Platform, ACTOR_CHAIN_PLATFORM, ACTOROVL_ALLOC_NORMAL, "Chain_Platform")
/* CUSTOM */ DEFINE_ACTOR(Gear_Shaft, ACTOR_GEAR_SHAFT, ACTOROVL_ALLOC_NORMAL, "Gear_Shaft")
/* CUSTOM */ DEFINE_ACTOR(Pendulum, ACTOR_PENDULUM, ACTOROVL_ALLOC_NORMAL, "Pendulum")
/* CUSTOM */ DEFINE_ACTOR(Moving_Platform, ACTOR_MOVING_PLATFORM, ACTOROVL_ALLOC_NORMAL, "Moving_Platform")
/* CUSTOM */ DEFINE_ACTOR(Fireplace, ACTOR_FIREPLACE, ACTOROVL_ALLOC_NORMAL, "Fireplace")
/* CUSTOM */ DEFINE_ACTOR(Small_Gear, ACTOR_SMALL_GEAR, ACTOROVL_ALLOC_NORMAL, "Small_Gear")
/* CUSTOM */ DEFINE_ACTOR(Gear_Slot, ACTOR_GEAR_SLOT, ACTOROVL_ALLOC_NORMAL, "Gear_Slot")
/* CUSTOM */ DEFINE_ACTOR(Bottle_Water, ACTOR_BOTTLE_WATER, ACTOROVL_ALLOC_NORMAL, "Bottle_Water")
/* CUSTOM */ DEFINE_ACTOR(Water_Plane, ACTOR_WATER_PLANE, ACTOROVL_ALLOC_NORMAL, "Water_Plane")
/* CUSTOM */ DEFINE_ACTOR(Wall_Pull_Switch, ACTOR_WALL_PULL_SWITCH, ACTOROVL_ALLOC_NORMAL, "Wall_Pull_Switch")
/* CUSTOM */ DEFINE_ACTOR(Steam, ACTOR_STEAM, ACTOROVL_ALLOC_NORMAL, "Steam")
/* CUSTOM */ DEFINE_ACTOR(Metal_Cube, ACTOR_METAL_CUBE, ACTOROVL_ALLOC_NORMAL, "Metal_Cube")
/* CUSTOM */ DEFINE_ACTOR(Swim_Ring, ACTOR_SWIM_RING, ACTOROVL_ALLOC_NORMAL, "Swim_Ring")
/* CUSTOM */ DEFINE_ACTOR(Water_Shutter, ACTOR_WATER_SHUTTER, ACTOROVL_ALLOC_NORMAL, "Water_Shutter")
/* CUSTOM */ DEFINE_ACTOR(Water_Pipe, ACTOR_WATER_PIPE, ACTOROVL_ALLOC_NORMAL, "Water_Pipe")
/* CUSTOM */ DEFINE_ACTOR(Air_Vent, ACTOR_AIR_VENT, ACTOROVL_ALLOC_NORMAL, "Air_Vent")
/* CUSTOM */ DEFINE_ACTOR(Bookshelf_Door, ACTOR_BOOKSHELF_DOOR, ACTOROVL_ALLOC_NORMAL, "Bookshelf_Door")
/* CUSTOM */ DEFINE_ACTOR(Talk_Spot, ACTOR_TALK_SPOT, ACTOROVL_ALLOC_NORMAL, "Talk_Spot")
/* CUSTOM */ DEFINE_ACTOR(Boost_Breakwall, ACTOR_BOOST_BREAKWALL, ACTOROVL_ALLOC_NORMAL, "Boost_Breakwall")
/* CUSTOM */ DEFINE_ACTOR(Rotating_Platform, ACTOR_ROTATING_PLATFORM, ACTOROVL_ALLOC_NORMAL, "Rotating_Platform")
/* CUSTOM */ DEFINE_ACTOR(Rat, ACTOR_RAT, ACTOROVL_ALLOC_NORMAL, "Rat")
