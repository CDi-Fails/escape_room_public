...
#define MEM_LOG(value, offset) (*(u32*)(0x80700000 + (offset * 4)) = value)
#define MEM_LOGF(value, offset) (*(f32*)(0x80700000 + (offset * 4)) = value)

#define COLLIDER_VIEW_ON AREG(15) = AREG(21) = AREG(22) = AREG(23) = 1
#define DYNA_VIEW_ON AREG(15) = AREG(24) = 1
