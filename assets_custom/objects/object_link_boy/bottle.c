...
#include "assets_custom/objects/object_link_boy/bottle_contents.i8.inc.c"
};

u64 gBottleGlassNewTex[] = {
#include "assets_custom/objects/object_link_boy/bottle_glass.i8.inc.c"
};

Vtx gameplay_keepVtx_000080[] = {
	VTX(-465, 313, -5, 354, 973, 90, 90, 90, 90),
	VTX(63, 561, 209, 296, 277, 255, 255, 255, 255),
	VTX(-466, 562, 205, 297, 976, 50, 50, 50, 50),
	VTX(64, 312, -1, 353, 274, 255, 255, 255, 255),
	VTX(-462, 436, -307, 411, 970, 50, 50, 50, 50),
	VTX(67, 435, -303, 411, 271, 182, 182, 182, 182),
	VTX(-461, 761, -283, 481, 971, 50, 50, 50, 50),
	VTX(67, 760, -279, 481, 272, 54, 54, 54, 54),
	VTX(67, 435, -303, 411, 271, 182, 182, 182, 182),
	VTX(-464, 839, 33, 225, 975, 50, 50, 50, 50),
	VTX(65, 838, 37, 225, 276, 118, 118, 118, 118),
	VTX(63, 561, 209, 296, 277, 255, 255, 255, 255),
	VTX(64, 312, -1, 353, 274, 255, 255, 255, 255),

	VTX(443, 756, -271, -17, 180, 1, 77, 165, 50),
	VTX(264, 756, -272, 155, 179, 33, 82, 176, 50),
	VTX(440, 833, 43, -12, 124, 0, 118, 18, 50),
	VTX(262, 834, 42, 159, 123, 29, 99, 60, 50),
	VTX(438, 558, 214, -16, 321, 255, 20, 118, 50),
	VTX(259, 559, 212, 155, 320, 36, 246, 114, 58),
	VTX(442, 433, -294, -23, 411, 1, 219, 143, 162),
	VTX(263, 434, -296, 148, 410, 38, 194, 161, 242),
	VTX(260, 312, 4, 149, 498, 48, 150, 27, 248),
	VTX(430, 311, 6, -14, 499, 255, 140, 29, 180),
	VTX(260, 312, 4, 34, 76, 48, 150, 27, 248),
	VTX(161, 397, -358, 43, 287, 38, 198, 159, 240),
	VTX(263, 434, -296, 49, 240, 38, 194, 161, 242),
	VTX(158, 243, 19, 25, 81, 24, 142, 28, 218),
	VTX(259, 559, 212, 46, -107, 36, 246, 114, 58),
	VTX(157, 555, 282, 38, -150, 36, 250, 114, 54),
	VTX(158, 243, 19, 25, 81, 24, 142, 28, 218),
	VTX(262, 834, 42, 76, -56, 29, 99, 60, 50),
	VTX(159, 901, 67, 85, -86, 42, 108, 31, 50),
	VTX(264, 756, -272, 78, 158, 33, 82, 176, 50),
	VTX(162, 803, -329, 88, 184, 45, 59, 163, 100),
	VTX(158, 243, 19, 281, 81, 24, 142, 28, 218),
	VTX(-550, 400, -366, 208, 293, 182, 190, 190, 50),
	VTX(161, 397, -358, 299, 287, 38, 198, 159, 240),
	VTX(-554, 246, 11, 225, 87, 193, 158, 24, 58),
	VTX(157, 555, 282, 294, -150, 36, 250, 114, 54),
	VTX(-555, 558, 274, 212, -144, 163, 233, 72, 50),
	VTX(-552, 904, 59, 175, -80, 211, 90, 64, 50),
...
Gfx gBottleGlassDL[] = {
    ...
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gBottleGlassNewTex, G_IM_FMT_I, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR |
                         G_TX_WRAP, 3, 3, 2, 3),
