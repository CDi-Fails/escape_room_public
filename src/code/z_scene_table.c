...
void Scene_DrawConfigEscapeRoom(PlayState* play) {
    u32 gameplayFrames;
    ...
    gSPSegment(POLY_OPA_DISP++, 0x08,
               Gfx_TwoTexScroll(play->state.gfxCtx, G_TX_RENDERTILE, 0, 0, 64, 64, 1, 0, gameplayFrames % 256, 64, 64));

    gSPSegment(POLY_XLU_DISP++, 0x08,
               Gfx_TwoTexScroll(play->state.gfxCtx, G_TX_RENDERTILE, 0, (gameplayFrames * 4) % 256, 64, 64, 1, 0, (gameplayFrames * 4) % 256, 64, 64));
    ...
    gSPSegment(POLY_XLU_DISP++, 0x0A,
               Gfx_TexScroll(play->state.gfxCtx, gameplayFrames, 0, 16, 64));
...
void (*sSceneDrawConfigs[SDC_MAX])(PlayState*) = {
    ...
    Scene_DrawConfigEscapeRoom,  // SDC_ESCAPE_ROOM
};
