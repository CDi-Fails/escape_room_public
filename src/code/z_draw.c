...
#include "assets_custom/objects/object_gi_heatgear/object_gi_heatgear.h"
#include "assets_custom/objects/object_gi_boosters/gGiBoosterGauntletDL.h"
#include "assets_custom/objects/object_gi_mirror_shield/gGiMirrorShieldDecalDL.h"
#include "assets_custom/objects/object_gi_mirror_shield/gGiMirrorShieldNewDL.h"
#include "assets_custom/objects/object_gi_zora_apparatus/gGiZoraApparatusDL.h"
...
void GetItem_DrawHeatGear(PlayState* play, s16 drawId);
...
DrawItemTableEntry sDrawItemTable[] = {
    ...
    // egg, OBJECT_GI_EGG
    { GetItem_DrawOpa0, { gGiBoosterGauntletDL } },
    ...
    { GetItem_DrawOpa0Xlu1, { gGiMirrorShieldNewDL, gGiMirrorShieldDecalDL } },
    // zelda's letter, OBJECT_GI_LETTER
    { GetItem_DrawOpa0Xlu1, { gGiLetterDL, gGiLetterWritingDL } },
    // goron tunic, OBJECT_GI_CLOTHES
    { GetItem_DrawHeatGear, { gGiHeatGearDL, gGiHeatGearGlowDL } },
    ...
    { GetItem_DrawOpa0, { gGiZoraApparatusDL } },
...
void GetItem_DrawHeatGear(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Opa(play->state.gfxCtx);
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(play->state.gfxCtx, __FILE__, __LINE__), G_MTX_MODELVIEW | G_MTX_LOAD);
    gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TexScroll(play->state.gfxCtx, (play->gameplayFrames * 2) % 64, 0, 16, 16));
