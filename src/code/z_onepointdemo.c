...
s32 OnePointCutscene_SetInfo(PlayState* play, s16 subCamId, s16 csId, Actor* actor, s16 timer) {
    ...
    switch (csId) {
        ...
        case 3050:
            Play_RequestCameraSetting(play, subCamId, CAM_SET_CS_3);
            Player_SetCsActionWithHaltedActors(play, &player->actor, PLAYER_CSACTION_SURPRISED);
        ...
        case 3150:
            ...
            subCam->roll = 0x50;
            subCam->fov = 55.0f;
            Player_SetCsAction(play, &player->actor, PLAYER_CSACTION_WAIT);
            break;
        ...
        case 3170:
            ...
            subCam->roll = -1;
            subCam->fov = 55.0f;
            Player_SetCsAction(play, actor, PLAYER_CSACTION_IDLE);
            break;
        ...
        case 3190:
            ...
            Player_SetCsAction(play, actor, PLAYER_CSACTION_FIGHT_STANCE);
            break;
        ...
        case 4220:
            ...
            Play_InitCameraDataUsingPlayer(play, subCamId, player, CAM_SET_CS_C);
            Player_SetCsAction(play, &player->actor, PLAYER_CSACTION_IDLE);
