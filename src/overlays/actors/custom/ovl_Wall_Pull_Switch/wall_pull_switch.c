...
#include "assets_custom/objects/object_wall_pull_switch/object_wall_pull_switch.h"
...
void WallPullSwitch_PlayerPulling(WallPullSwitch* this, PlayState* play) {
    ...
    if (this->timer == 1) {
        player->stateFlags1 |= PLAYER_STATE2_DISABLE_MOVE_ROTATION_WHILE_Z_TARGETING;
