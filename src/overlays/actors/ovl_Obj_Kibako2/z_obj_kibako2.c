...
void ObjKibako2_Kill(ObjKibako2* this, PlayState* play) {
    ...
    if ((params & 0x8000) == 0) {
        ...
        Actor_Spawn(&play->actorCtx, play, ACTOR_SMALL_GEAR, this->dyna.actor.world.pos.x, this->dyna.actor.world.pos.y,
                    this->dyna.actor.world.pos.z, 0, this->dyna.actor.shape.rot.y, 0, 0x0004);
    }
