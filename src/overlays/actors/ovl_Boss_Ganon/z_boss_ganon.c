...
void BossGanon_IntroCutscene(BossGanon* this, PlayState* play) {
    ...
    switch (this->csState) {
        ...
        case 2:
            ...
            if (this->csTimer == 10) {
                Player_SetCsActionWithHaltedActors(play, &this->actor, PLAYER_CSACTION_SURPRISED);
            }
        ...
        case 5:
            ...
            if (this->csTimer == 10) {
                Player_SetCsActionWithHaltedActors(play, &this->actor, PLAYER_CSACTION_TRIFORCE_HAND_RESONATES);
            }
        ...
        case 11: // link is healed
            ...
            if (this->csTimer == 20) {
                Player_SetCsActionWithHaltedActors(play, &this->actor, PLAYER_CSACTION_LOOK_AT_SELF);
        ...
        case 20: // zoom cam out
            ...
            if (this->csTimer == 30) {
                Player_SetCsActionWithHaltedActors(play, &this->actor, PLAYER_CSACTION_RESIST_DARK_MAGIC);
            }
...
void BossGanon_DeathAndTowerCutscene(BossGanon* this, PlayState* play) {
    ...
    switch (this->csState) {
        ...
        case 9:
            ...
            if (this->csTimer == 2) {
                Player_SetCsActionWithHaltedActors(play, &this->actor, PLAYER_CSACTION_LOOK_AROUND_SURPRISED);
            }
        ...
        case 102:
            ...
            if (this->csTimer == 5) {
                Player_SetCsActionWithHaltedActors(play, &this->actor, PLAYER_CSACTION_STARE_DOWN_STARTLED);
            }

            if (this->csTimer == 70) {
                Player_SetCsActionWithHaltedActors(play, &this->actor, PLAYER_CSACTION_LOOK_UP_STARTLED);
            }
...
void func_808E2544(Actor* thisx, PlayState* play) {
    ...
    switch (this->unk_1C2) {
        ...
        case 11:
            ...
            if ((player->meleeWeaponState != 0) && (player->meleeAttackType >= PLAYER_MELEEATKTYPE_SPIN_ATTACK_1H) &&
