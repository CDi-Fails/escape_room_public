...
#define FLAGS (ACTOR_FLAG_0 | ACTOR_FLAG_2 | ACTOR_FLAG_4 | ACTOR_FLAG_IGNORE_QUAKE | ACTOR_FLAG_14)
...
static ColliderCylinderInit sCylinderInit = {
    ...
    { 9 * BIRI_LARGE_SCALE, 28 * BIRI_LARGE_SCALE, -20 * BIRI_LARGE_SCALE, { 0, 0, 0 } },
};

static CollisionCheckInfoInit2 sColChkInfoInit = { 1, 9 * BIRI_LARGE_SCALE, 28 * BIRI_LARGE_SCALE, -20 * BIRI_LARGE_SCALE, 30 };
...
void EnBili_Init(Actor* thisx, PlayState* play) {
    ...
    Actor_SetScale(&this->actor, 0.01f * BIRI_LARGE_SCALE);
...
void EnBili_SetupApproachPlayer(EnBili* this) {
    this->actor.speed = 1.2f * (BIRI_LARGE_SCALE * 0.25f);
...
void EnBili_FloatIdle(EnBili* this, PlayState* play) {
    ...
    if ((this->actor.xzDistToPlayer < 160.0f * BIRI_LARGE_SCALE) && (fabsf(this->actor.yDistToPlayer) < 45.0f * BIRI_LARGE_SCALE)) {
