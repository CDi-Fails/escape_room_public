...
u8 gEquipAgeReqs[4][4] = {
    ...
    },
    {
        ...
        AGE_REQ_ADULT, // EQUIP_TYPE_TUNIC EQUIP_VALUE_TUNIC_HEATSINK
    ...
    },
    {
        ...
        AGE_REQ_ADULT, // EQUIP_TYPE_BOOTS EQUIP_VALUE_BOOTS_ZORA
...
void KaleidoScope_Update(PlayState* play) {
    ...
    switch (pauseCtx->state) {
        case PAUSE_STATE_INIT:
            ...
            if (CHECK_OWNED_EQUIP(EQUIP_TYPE_BOOTS, EQUIP_INV_BOOTS_ZORA)) {
        ...
        case PAUSE_STATE_RESUME_GAMEPLAY:
            ...
            interfaceCtx->doActionOnB = interfaceCtx->unk_1FC = 0;
            osSyncPrintf(VT_FGCOL(YELLOW));
